resource_group_name = "rg-seventy5-stage21-eastus2"
location            = "eastus2"
environment         = "stage"
subscription_id     = "b3dbc3a4-6783-42c2-a80a-4a1db42f7e83"
# SQL Server
sql_server_name                           = "sql-seventy5-eus2n0s"
sql_server_admin_login_name               = "edsdba"
enable_azuread_administrator              = true
sql_server_aad_admin_login_name           = "gAZ10654-sql-seventy5-eus2n0s-sa"
active_directory_admin_object_id          = "a9bf9659-520b-4821-8ac4-13d683d1a015"
deploy_sql_server_log_analytics_workspace = false
log_analytics_name                        = ""
deploy_sql_server_key_vault               = true
key_vault_name                            = "kv-75-stage-eastus2"
...
single_database_name                         = "sqldb-seventy5db-s"
...
single_database_backup_retention_days        = 20
...
action_group_name                            = "sqldb-seventy5db-s-action-group"
action_group_alerts_email_id                 = "dbasqlcorp@kroger.com"

federated_identity_credential_name = "seventy5-federated-stage"
issuer                             = "https://eastus2.oic.prod-aks.azure.com/8331e14a-9134-4288-bf5a-5e2c8412f074/06f064da-d42d-4b3c-9732-ddfd425a409c/"
namespace                          = "seventy5-stage"
serviceaccount                     = "id-seventy5-stage-eastus2"
...
sql_private_endpoints = {
  ...
  "sql-seventy5-stage-eastus2-nonprod-eastus2-prvendpt" = {
  ...
  "sql-seventy5-stage-eastus2-nonprod-centralus-prvendpt" = {
  ...
  "sql-seventy5-stage-eastus2-prod-eastus2-prvendpt" = {
    subnet_location            = "eastus2"
  ...
  "sql-seventy5-stage-eastus2-prod-centralus-prvendpt" = {
    subnet_location            = "centralus"
